...
import com.example.emergencyinformationapp.databinding.ActivityEditBinding
...
class EditActivity : AppCompatActivity() {
    ...
    private fun saveData() {
        with(getSharedPreferences(USER_INFORMATION, Context.MODE_PRIVATE).edit()) {
            ...
            putString(EMERGENCY_CONTACT, binding.emergencyPhoneNumberEditText.text.toString())
