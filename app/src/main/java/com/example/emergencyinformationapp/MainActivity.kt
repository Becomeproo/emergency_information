package com.example.emergencyinformationapp
...
import com.example.emergencyinformationapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emergencyContactLayer.setOnClickListener {
            with(Intent(Intent.ACTION_VIEW)) {
                val phoneNumber = binding.emergencyPhoneNumberValueTextView.text.toString()
                    .replace("-", "")
    ...
    private fun getDataUiUpdate() {
        with(getSharedPreferences(USER_INFORMATION, Context.MODE_PRIVATE)) {
            ...
            binding.emergencyPhoneNumberValueTextView.text = getString(EMERGENCY_CONTACT, "미정")
